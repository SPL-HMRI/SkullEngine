...
__C.general.training_image_list_file = 'C:/Project/DentalEngine-main/Train/train_bone_1.txt' #'/shenlab/lab_stor6/projects/CT_Dental/dataset/landmark_detection/train_server.csv'
